###########################################################################
## Makefile generated for component 'MotorControl0'. 
## 
## Makefile     : MotorControl0.mk
## Generated on : Fri Jun 27 17:05:34 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MotorControl0.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MotorControl0.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/MotorControl0_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=MotorControl0 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/MotorControl0_ert_rtw/MotorControl0.cpp $(START_DIR)/MotorControl0_ert_rtw/MotorControl0_data.cpp
...
OBJS = MotorControl0.o MotorControl0_data.o
...
%.o : $(START_DIR)/MotorControl0_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/MotorControl0_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/MotorControl0_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MotorControl0.o : $(START_DIR)/MotorControl0_ert_rtw/MotorControl0.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MotorControl0_data.o : $(START_DIR)/MotorControl0_ert_rtw/MotorControl0_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
