###########################################################################
## Makefile generated for component 'Slip_Control_CodeGen'. 
## 
## Makefile     : Slip_Control_CodeGen.mk
## Generated on : Sun Nov 30 14:28:28 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Slip_Control_CodeGen
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Slip_Control_CodeGen
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Slip_Control_CodeGen_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Slip_Control_CodeGen -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Slip_Control_CodeGen_ert_rtw/Slip_Control_CodeGen.cpp $(START_DIR)/Slip_Control_CodeGen_ert_rtw/Slip_Control_CodeGen_data.cpp

MAIN_SRC = $(START_DIR)/Slip_Control_CodeGen_ert_rtw/ert_main.cpp
...
OBJS = Slip_Control_CodeGen.o Slip_Control_CodeGen_data.o
...
%.o : $(START_DIR)/Slip_Control_CodeGen_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Slip_Control_CodeGen_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Slip_Control_CodeGen_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Slip_Control_CodeGen_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Slip_Control_CodeGen_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Slip_Control_CodeGen.o : $(START_DIR)/Slip_Control_CodeGen_ert_rtw/Slip_Control_CodeGen.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Slip_Control_CodeGen_data.o : $(START_DIR)/Slip_Control_CodeGen_ert_rtw/Slip_Control_CodeGen_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Slip_Control_CodeGen_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
