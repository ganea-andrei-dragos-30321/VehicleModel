...
; int32_T i ; ( void ) t1 ; ( void ) LC ; out -> mTDXY_P . mNumCol = 153UL ;
out -> mTDXY_P . mNumRow = 24UL ; for ( i = 0 ; i < 154 ; i ++ ) { out ->
...
-> mTDXY_P . mIr [ 26 ] = _cg_const_2 [ 26 ] ; ( void ) LC ; ( void ) out ;
return 0 ; }
