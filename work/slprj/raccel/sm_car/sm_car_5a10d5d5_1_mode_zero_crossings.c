...
const NeZCData * sm_car_5a10d5d5_1_ZCData = NULL ; PmfMessageId
sm_car_5a10d5d5_1_computeAsmModeVector ( const double * input , const double
...
sm_car_5a10d5d5_1_computeSimModeVector ( const double * input , const double
* inputDot , const double * inputDdot , int * modeVector , double *
errorResult , NeuDiagnosticManager * neDiagMgr ) { ( void ) input ; ( void )
inputDot ; ( void ) inputDdot ; ( void ) modeVector ; ( void ) neDiagMgr ;
errorResult [ 0 ] = 0.0 ; return NULL ; } PmfMessageId
sm_car_5a10d5d5_1_computeZeroCrossings ( const RuntimeDerivedValuesBundle *
