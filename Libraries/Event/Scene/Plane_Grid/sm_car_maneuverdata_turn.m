...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Brake.rPedal.Value     = [0.00	0.00	0.40	0.40	0.00	0.00];
    ...
    mdata.(Instance).Steer.aWheel.Value    = deg2rad([0.0000	0.0000	30	30	0.0000	0.00000]);
    ...
    mdata.(Instance).Accel.rPedal.Value    = [0.00	0.00	0.50	0.50	0.00	0.00];
