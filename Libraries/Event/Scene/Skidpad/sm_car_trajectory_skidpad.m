...
v_lc        = 10.8;     % Speed during circle (m/s)
...
% Interpolate to get lateral distance and spsseed
...
save Skidpad_trajectory_default x y z vx aYaw xTrajectory 
