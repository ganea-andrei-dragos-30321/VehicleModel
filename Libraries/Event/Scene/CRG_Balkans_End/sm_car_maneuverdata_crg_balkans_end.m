function maneuver_data = sm_car_maneuverdata_crg_balkans_end

maneuver_type = 'CRG_Balkans_End';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Balkans_End_trajectory_default.mat';
