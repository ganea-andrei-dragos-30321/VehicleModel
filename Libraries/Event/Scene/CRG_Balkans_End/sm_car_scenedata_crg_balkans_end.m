    function scene_data = sm_car_scenedata_crg_balkans_end
%% Scene parameters
...
scene_data.Name               = 'CRG_Balkans_End';
scene_data.CRGfile            = 'CRG_Balkans_End.crg';
scene_data.Geometry.filename  = 'CRG_Balkans_End.stl';
...
scene_data.Geometry.centerline.filename  = 'CRG_Balkans_End_centerline.stl';
...
load('CRG_Balkans_End_dat');
if isfield(dat, 'rz')
    scene_data.Geometry.centerline.xyz   = [dat.rx' dat.ry' dat.rz']; % m
else
    scene_data.Geometry.centerline.xyz   = [dat.rx' dat.ry' zeros(size(dat.rx'))]; % m
end % m
