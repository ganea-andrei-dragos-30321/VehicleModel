function maneuver_data = sm_car_maneuverdata_crg_teste_f

maneuver_type = 'CRG_Teste_F';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Teste_f_trajectory_default.mat';
