function maneuver_data = sm_car_maneuverdata_crg_balkans_f

maneuver_type = 'CRG_Balkans_F';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Balkans_f_trajectory_default.mat';
    ...
    mdata.(Instance).vGain.Value           = 0.90; % m
