function maneuver_data = sm_car_maneuverdata_crg_balkans

maneuver_type = 'CRG_Balkans';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Balkans_trajectory_default.mat';
