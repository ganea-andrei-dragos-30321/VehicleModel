function traj_coeff = CRG_Create_Balkans
...
file_data = readtable("CRG_Balkans_centerline.xlsx");
if width(file_data)<5
    ...
    writetable([file_data,dist],'CRG_Balkans_centerline.xlsx','WriteMode','overwrite','WriteVariableNames',true);
    clear dist dist_m
end
clear file_data;
if(nargout == 0)
...
if(nargout == 0)
    ...
    sm_car_trajectory_calc('CRG_Balkans',traj_coeff)
    
    % Create driver trajectory for road with elevation
    sm_car_trajectory_calc('CRG_Balkans_f',traj_coeff)
end