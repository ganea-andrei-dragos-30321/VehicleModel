function scene_data = sm_car_scenedata_crg_dej_wide_f
%% Scene parameters
...
scene_data.Name               = 'CRG_Dej_Wide_F';
...
load('CRG_Dej_Wide_f_dat');
scene_data.Geometry.centerline.xyz   = [dat.rx' dat.ry' 0*zeros(size(dat.rx))']; % m
