function maneuver_data = sm_car_maneuverdata_crg_dej_wide

maneuver_type = 'CRG_Dej_Wide';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Dej_Wide_trajectory_default.mat';
    ...
    mdata.(Instance).xPreview.x.Value      = [2 3 6]; % m
