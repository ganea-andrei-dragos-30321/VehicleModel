function traj_coeff = CRG_Create_Dej_Wide
...
file_data = readtable("CRG_Dej_Wide_centerline.xlsx");
if width(file_data)<5
    ...
    writetable([file_data,dist],'CRG_Dej_Wide_centerline.xlsx','WriteMode','overwrite','WriteVariableNames',true);
    clear dist dist_m
end
clear file_data;
if(nargout == 0)
    ...
    road_opts.decim_alti = 30;
    road_opts.road_width = 5;      % Half width of the road
