function scene_data = sm_car_scenedata_crg_dej_wide
%% Scene parameters
...
scene_data.Name               = 'CRG_Dej_Wide';
scene_data.CRGfile            = 'CRG_Dej_Wide.crg';
...
scene_data.Geometry.centerline.filename  = 'CRG_Dej_Wide_centerline.stl';
...
load('CRG_Dej_Wide_dat');
scene_data.Geometry.centerline.xyz   = [dat.rx' dat.ry' [dat.rc 0 0]']; % m
