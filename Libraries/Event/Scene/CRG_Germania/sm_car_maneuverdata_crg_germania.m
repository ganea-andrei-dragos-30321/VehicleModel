function maneuver_data = sm_car_maneuverdata_crg_germania

maneuver_type = 'CRG_Germania';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Germania_trajectory_default.mat';
