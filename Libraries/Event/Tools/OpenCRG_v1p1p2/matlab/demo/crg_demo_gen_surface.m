...
while iu0(2) < iend
    ...
    crgsurf.ct{1}  = sprintf('demo segment generated by %s at %s', mfilename, datetime("now"));
...
crgsurf.ct{1}  = sprintf('demo surface generated by %s at %s', mfilename, datetime("now"));
crg_write(crgsurf, crgsurf.filenm);
